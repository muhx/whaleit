...
(window as any).__whaleit_query_client__ = queryClient;
```
...
```typescript
import { QueryKeys } from "@whaleit/addon-sdk";
```
...
components of the Whaleit ecosystem.
