//! PG sync engine ports for device sync.
//!
//! Implements OutboxStore and ReplayStore traits from whaleit-device-sync
//! by delegating to PgAppSyncRepository (stubs for PG mode).
...
#[derive(Clone)]
pub struct PgSyncEngineDbPorts {
    repository: Arc<PgAppSyncRepository>,
}

impl PgSyncEngineDbPorts {
    pub fn new(repository: Arc<PgAppSyncRepository>) -> Self {
        Self { repository }
    }
}
...
#[async_trait]
impl ReplayStore for PgSyncEngineDbPorts {
