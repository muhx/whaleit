...
import { useWhaleItConnect } from "../providers/connect-provider";
import {
  listBrokerAccounts,
      ...
      <CardContent className="py-8">
        <div className="flex flex-col items-center justify-center text-center">
          ...
          <p className="text-muted-foreground mb-4 max-w-sm text-sm">
            We&apos;re having trouble connecting to WhaleIt Connect. This is usually temporary and
    ...
    <div className="space-y-6">
        ...
        <CardContent className="p-4">
          <div className="flex items-center gap-3">
            ...
            <ActionConfirm
              ...
              confirmTitle="Sign out of WhaleIt Connect?"
      ...
      <footer className="border-t pt-4">
        <p className="text-muted-foreground text-center text-xs leading-relaxed">
          WhaleIt Connect doesn&apos;t store your brokerage credentials or financial data.
