...
import { ConnectEmptyState } from "@/features/connect/components/connect-empty-state";
import {
  useAggregatedSyncStatus,
  useBrokerAccounts,
  useImportRunsInfinite,
} from "@/features/connect/hooks";
import { useSyncBrokerData } from "@/features/connect/hooks/use-sync-broker-data";
import { useWhaleItConnect } from "@/features/connect/providers/connect-provider";
import { useAccounts } from "@/hooks/use-accounts";
import { WEALTHFOLIO_CONNECT_PORTAL_URL } from "@/lib/constants";
import { QueryKeys } from "@/lib/query-keys";
import { useQuery, useQueryClient } from "@tanstack/react-query";
import { Alert } from "@whaleit/ui/components/ui/alert";
...
export default function ConnectPage() {
  const { isEnabled, isConnected, isInitializing, userInfo } = useWhaleItConnect();
