...
// NOTE: The underlying infrastructure URL is intentionally still on the
// Whaleit domain until infra URL rebranding is completed.
export const WEALTHFOLIO_CONNECT_PORTAL_URL = "https://connect.whaleit.app";
