...
|---------|------|------|-------------|------------|-----------------|-----------|-------------------|-------------|--------|
| T1-01 | 01 | 1 | BRAND-01 | - | No user-facing "Wealthfolio" strings | build | `pnpm build && cargo check` | ✗ | pending |
| T1-02 | 01 | 1 | BRAND-06 | - | Internal crate names unchanged | grep | `grep -c 'name = "wealthfolio' Cargo.toml` | ✗ | pending |
| T2-01 | 02 | 1 | BRAND-02,03 | - | New color palette in globals.css | file | `test -f globals.css` | ✗ | pending |
| T2-02 | 02 | 1 | BRAND-02,04 | - | Icon assets exist in all formats | file | `ls apps/tauri/icons/icon.icns` | ✗ | pending |
| T3-01 | 03 | 2 | BRAND-01 | - | Package scope renamed | build | `pnpm build` | ✗ | pending |
| T3-02 | 03 | 2 | BRAND-01 | - | Feature dir renamed | file | `test -d features/connect` | ✗ | pending |
| T4-01 | 04 | 2 | BRAND-01 | - | Web adapter modularized | build | `pnpm type-check` | ✗ | pending |
| T4-02 | 04 | 2 | BRAND-01 | - | Types.ts split with barrel | build | `pnpm type-check` | ✗ | pending |
