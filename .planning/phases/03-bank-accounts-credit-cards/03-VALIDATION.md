...
| ------- | ---- | ---- | -------------- | ---------- | ------------------------------------------------------------------------- | ------------------ | ------------------------------------------------------------------------------------------------------------------ | -------------------------------- | ---------- |
| TBD     | 01   | 1    | (migration)    | T-3-01     | Schema migration applies cleanly; no orphan indices                       | Rust integration   | `cargo test -p whaleit-storage-postgres accounts::migration_tests::test_migration_up_down`                         | ❌ W0                            | ⬜ pending |
| TBD     | TBD  | TBD  | ACCT-01        | —          | Bank-account creation persists all fields                                 | Rust unit          | `cargo test -p whaleit-core accounts::accounts_model_tests::test_new_account_validate_bank`                        | ❌ W0 (extend)                   | ⬜ pending |
...
| TBD     | TBD  | TBD  | ACCT-02        | T-3-02     | CC create rejects missing `credit_limit` / invalid `statement_cycle_day`  | Rust unit          | `cargo test -p whaleit-core accounts::accounts_model_tests::test_new_account_validate_credit_card_rejects_invalid` | ❌ W0                            | ⬜ pending |
| TBD     | TBD  | TBD  | ACCT-02        | —          | CC create accepts valid credit_limit + cycle_day                          | Rust unit          | `cargo test -p whaleit-core accounts::accounts_model_tests::test_new_account_validate_credit_card`                 | ❌ W0                            | ⬜ pending |
| TBD     | TBD  | TBD  | ACCT-02        | T-3-02     | Non-CC create rejects CC fields present                                   | Rust unit          | `cargo test -p whaleit-core accounts::accounts_model_tests::test_new_account_validate_non_cc_rejects_cc_fields`    | ❌ W0                            | ⬜ pending |
...
| TBD     | TBD  | TBD  | ACCT-05 / D-03 | —          | `account_kind()` maps types correctly (Rust)                              | Rust unit          | `cargo test -p whaleit-core accounts::tests::test_account_kind`                                                    | ❌ W0                            | ⬜ pending |
...
| TBD     | TBD  | TBD  | D-12           | —          | Updating `current_balance` bumps `balance_updated_at`                     | Rust unit + integ. | `cargo test -p whaleit-core accounts::accounts_service_tests::test_update_bumps_balance_timestamp`                 | ❌ W0                            | ⬜ pending |
